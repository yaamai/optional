...
// This file was generated by robots at 2019-08-03 10:39:59.201364953 +0000 UTC
...
// Unwrap returns the uint8 value or an error if not present.
...
func (u Uint8) MarshalYAML() ([]byte, error) {
	if u.Present() {
...
func (u *Uint8) UnmarshalYAML(data []byte) error {
