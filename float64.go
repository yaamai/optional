...
// This file was generated by robots at 2019-08-03 10:39:54.355600172 +0000 UTC
...
// Unwrap returns the float64 value or an error if not present.
...
func (f Float64) MarshalYAML() ([]byte, error) {
	if f.Present() {
...
func (f *Float64) UnmarshalYAML(data []byte) error {
