...
// This file was generated by robots at 2019-08-03 10:39:56.475741703 +0000 UTC
...
// Unwrap returns the int8 value or an error if not present.
...
func (i Int8) MarshalYAML() ([]byte, error) {
	if i.Present() {
...
func (i *Int8) UnmarshalYAML(data []byte) error {
