...
// This file was generated by robots at 2019-08-03 10:39:56.872513297 +0000 UTC
...
// Unwrap returns the rune value or an error if not present.
func (r Rune) Unwrap() rune {
	return *r.value
}
...
func (r Rune) MarshalYAML() ([]byte, error) {
	if r.Present() {
		return yaml.Marshal(r.value)
	}
	return yaml.Marshal(nil)
}

func (r *Rune) UnmarshalYAML(data []byte) error {
