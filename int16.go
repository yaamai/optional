...
// This file was generated by robots at 2019-08-03 10:39:55.148328762 +0000 UTC
...
// Unwrap returns the int16 value or an error if not present.
...
func (i Int16) MarshalYAML() ([]byte, error) {
	if i.Present() {
...
func (i *Int16) UnmarshalYAML(data []byte) error {
